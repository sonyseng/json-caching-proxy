...
const remoteServerUrl = 'http://localhost:'+ mockServerPort;
const proxyPort = 8119;
const proxyServerUrl = 'http://localhost:'+ proxyPort;
const cacheDataDirectory = 'cache';
const commandPrefix = 'proxy';
const proxyHeaderIdentifier = 'json-cached-proxy-playback';
